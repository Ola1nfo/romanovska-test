            ...
            <div className="tutorial-panel" ref={panelRef}>
                ...
                <div className="panel-content">
                    <div className="panel-items">
                        <div className="item">
                            <div className="icon"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-mouse" viewBox="0 0 16 16">
                        ...
                        <div className="item">
                            <div className="icon"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-eye" viewBox="0 0 16 16">
                        ...
                        <div className="item">
                            <div className="icon"><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-menu-button-wide" viewBox="0 0 16 16">
